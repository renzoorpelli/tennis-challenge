...
namespace TennisChallenge.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241008010318_Initial")]
            ...
            modelBuilder.Entity("TennisChallenge.Core.Entities.Tournaments.Tournament", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 9, 28, 1, 3, 17, 726, DateTimeKind.Utc).AddTicks(6897),
                            MatchesCount = 8,
                            Name = "Spring Championship",
                            StartDate = new DateTime(2024, 9, 23, 1, 3, 17, 726, DateTimeKind.Utc).AddTicks(6889),
                            TournamentType = "Male"
                        },
                        new
                        {
                            Id = new Guid("1f783aab-2a28-4371-917a-330b56f6bf1a"),
                            EndDate = new DateTime(2024, 10, 6, 1, 3, 17, 726, DateTimeKind.Utc).AddTicks(6915),
                            MatchesCount = 8,
                            Name = "Summer Showdown",
                            StartDate = new DateTime(2024, 9, 30, 1, 3, 17, 726, DateTimeKind.Utc).AddTicks(6914),
                            TournamentType = "Male"
                        },
                        new
                        {
                            Id = new Guid("8d62d922-192d-40cf-acc4-8430b030c37a"),
                            EndDate = new DateTime(2024, 10, 8, 1, 3, 17, 726, DateTimeKind.Utc).AddTicks(6920),
                            MatchesCount = 8,
                            Name = "Female Autumn Invitational",
                            StartDate = new DateTime(2024, 10, 3, 1, 3, 17, 726, DateTimeKind.Utc).AddTicks(6919),
                            TournamentType = "Female"
                        },
                        new
                        {
                            Id = new Guid("c3d4097b-d01e-4e28-aa64-56233b158d83"),
                            EndDate = new DateTime(2024, 10, 8, 1, 3, 17, 726, DateTimeKind.Utc).AddTicks(6924),
                            MatchesCount = 8,
                            Name = "Male Autumn Invitational",
                            StartDate = new DateTime(2024, 10, 3, 1, 3, 17, 726, DateTimeKind.Utc).AddTicks(6923),
                            TournamentType = "Male"
                        });
                });
